...
--
-- Host: localhost:3306
-- Generation Time: Apr 07, 2016 at 11:00 AM
...
--
CREATE DATABASE IF NOT EXISTS `cmpt483a_tasteitagain` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cmpt483a_tasteitagain`;
...
CREATE TABLE IF NOT EXISTS `USERS` (
  ...
  `EMPFLAG` enum('Y','N') NOT NULL DEFAULT 'N',
  PRIMARY KEY (`USERID`),
...
INSERT INTO `USERS` (`USERID`, `EMAILADD`, `PWHASH`, `FIRSTNAME`, `MINIT`, `LASTNAME`, `PHONE`, `ADMINFLAG`, `OWNERFLAG`, `CUSTFLAG`, `EMPFLAG`) VALUES
(0000000100, 'ksmiller99@yahoo.com', 'c57d4dbfea564b7c33cfae2b41864503', 'Kevin', 'S', 'Miller', 9734297945, 'Y', 'Y', 'Y', 'N'),
(0000000146, 'test1@test.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'Test1', '', 'User', 1234567890, 'N', 'N', 'Y', 'N'),
(0000000147, 'test2@test.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'test2', '', 'User', 1234567890, 'N', 'N', 'Y', 'N'),
(0000000152, 'testa@test.com', 'c57d4dbfea564b7c33cfae2b41864503', 'TestA', '', 'User', 1234567890, 'N', 'N', 'Y', 'N'),
(0000000153, 'spinz001@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'Matt', '', 'Haight', 2012133793, 'Y', 'Y', 'Y', 'N'),
(0000000154, 'testcust@test.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'Testcust', '', 'Customer', 9731234567, 'N', 'N', 'Y', 'N'),
(0000000155, 'testadmin@test.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'TestAdmin', '', 'Admin', 1234567890, 'Y', 'N', 'Y', 'N'),
(0000000156, 'testowner@test.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'TestOwner', '', 'Owner', 7539518520, 'Y', 'Y', 'Y', 'N');
