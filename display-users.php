...
<html>
    <head>
        ...
        <script language="javascript" src="ajax_users.js"></script>
        ...
        <script language="JavaScript">
            function edit_field(multi) {
                ...
                //to prevent JS from treating primary key as integer and stripping leading 0's
                var sid = 's' + row[0];
                ...
                document.getElementById(sid).innerHTML = '<input type=button value=Update onclick=ajax_users("' + sid + '");>'; // Add different color to background
            } // end of function
